...
const IconPlaceholder = ({ type }) => {
  ...
  if (type === 'Branding') iconContent = '🏷️';
  if (type === 'Packaging') iconContent = '📦';
  if (type === 'Social Media') iconContent = '📱';
  if (type === 'Stationery') iconContent = '✒️';
  if (type === 'Coffee Table Books') iconContent = '📚';
  if (type === 'Creative Projects') iconContent = '💡';
